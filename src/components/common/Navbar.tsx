...
import { Radio, Layers, BookOpen, Play, Pause, Activity, Sparkles, Wifi, Cpu, Terminal, Bot, Volume2, VolumeX, Box } from 'lucide-react';
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* 3D Blender Viewport button */}
          {onOpen3D && (
            <button
              onClick={onOpen3D}
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-mono font-semibold text-emerald-300 border border-emerald-700/50 bg-emerald-950/50 hover:bg-emerald-900/60 hover:border-emerald-500/60 transition-all duration-200 shadow-[0_0_10px_rgba(52,211,153,0.2)]"
              title="Open Blender 3D CAD & Ray Physics Viewport"
            >
              <Box className="w-3.5 h-3.5 text-emerald-400" />
              <span className="hidden lg:inline">3D CAD MODEL</span>
            </button>
          )}
