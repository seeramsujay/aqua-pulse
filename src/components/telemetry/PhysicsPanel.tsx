      ...
      <div className="px-4 pt-3.5">
        <div className="panel-header">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="panel-title text-amber-400">Acoustic Physics</div>
              <p className="text-[9px] text-slate-500 mt-0.5">Chirp Spread Spectrum Modulator</p>
            </div>
          </div>
      ...
      <div className="px-4 pb-4 flex flex-col gap-3 flex-1">
        ...
        {mode === 'rc-css' ? (
          ...
          <div className="rounded-lg border border-rose-900/50 bg-rose-950/20 px-3 py-2.5">
            <div className="flex items-center gap-2 font-mono text-[11px] text-rose-300">
              ...
              <span><strong>Conventional Fixed Sonar Active</strong> — Single 45 kHz CW tone. No frequency agility or pulse compression gain.</span>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-2 flex-1">
          <div className="telemetry-cell">
            ...
            <div className="telemetry-value text-amber-300">{thorpAlpha.toFixed(2)}</div>
          ...
          <div className="telemetry-cell">
            ...
            <div className="telemetry-value text-violet-300">+{compressionGainDb.toFixed(1)}</div>
          ...
          <div className="telemetry-cell">
            ...
            <div className="telemetry-value text-cyan-300">{timeBandwidthProduct}</div>
          ...
          <div className="telemetry-cell">
            ...
            <div className="telemetry-value text-emerald-300 text-sm leading-tight">{snellInvariant}</div>
